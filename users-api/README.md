## Pre-installation
 ...
 2. Create database with some name or `otus_users_db`
 3. Setup Node.js v20

## Clone project

```bash
$ git clone git@otusteam.gitlab.yandexcloud.net:devops/devops-otus-app/users-api.git
```
...
```bash
$ curl http://{HOST}:{PORT}/users/health-check
```
